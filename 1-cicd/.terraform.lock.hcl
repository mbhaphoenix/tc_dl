...
provider "registry.terraform.io/hashicorp/google" {
  version     = "6.13.0"
  constraints = ">= 3.43.0, >= 3.50.0, >= 4.28.0, != 4.31.0, >= 4.83.0, >= 5.31.0, >= 5.41.0, >= 5.43.0, <= 6.13.0, < 7.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "6.13.0"
  constraints = ">= 3.43.0, >= 3.50.0, >= 4.11.0, != 4.31.0, >= 4.83.0, >= 5.41.0, <= 6.13.0, < 7.0.0"
  hashes = [
    "h1:AWa4Ls4Js4WDnLYCYXT246EDyVKmBo/+3Zr9JRfJWqY=",
